//#############################################################################
// FILE:   config.C
// TITLE:  Peripheral configurations
//
//  Group           : C2000
...
{
	// set up EPWM-AH
	GPIO_SetupPinOptions(MOTOR2_EPWM_AH_GPIO, GPIO_OUTPUT, GPIO_PULLUP);
	GPIO_SetupPinMux(MOTOR2_EPWM_AH_GPIO, 0, MOTOR2_EPWM_AH_MUX);

	// set up EPWM-AL
	GPIO_SetupPinOptions(MOTOR2_EPWM_AL_GPIO, GPIO_OUTPUT, GPIO_PULLUP);
	GPIO_SetupPinMux(MOTOR2_EPWM_AL_GPIO, 0, MOTOR2_EPWM_AL_MUX);

	// set up EPWM-BH
	GPIO_SetupPinOptions(MOTOR2_EPWM_BH_GPIO, GPIO_OUTPUT, GPIO_PULLUP);
	GPIO_SetupPinMux(MOTOR2_EPWM_BH_GPIO, 0, MOTOR2_EPWM_BH_MUX);

	// set up EPWM-BL
	GPIO_SetupPinOptions(MOTOR2_EPWM_BL_GPIO, GPIO_OUTPUT, GPIO_PULLUP);
	GPIO_SetupPinMux(MOTOR2_EPWM_BL_GPIO, 0, MOTOR2_EPWM_BL_MUX);

	// set up EPWM-CH
	GPIO_SetupPinOptions(MOTOR2_EPWM_CH_GPIO, GPIO_OUTPUT, GPIO_PULLUP);
	GPIO_SetupPinMux(MOTOR2_EPWM_CH_GPIO, 0, MOTOR2_EPWM_CH_MUX);

	// set up EPWM-CL
	GPIO_SetupPinOptions(MOTOR2_EPWM_CL_GPIO, GPIO_OUTPUT, GPIO_PULLUP);
	GPIO_SetupPinMux(MOTOR2_EPWM_CL_GPIO, 0, MOTOR2_EPWM_CL_MUX);
...
void InitMotor2_DRV_Gpio(void)
{
	...
	// Configure as Output : Motor 2 - DC-CAL for DRV8301
	...
	// Configure as Output : Motor 2 - WAKE for DRV8305

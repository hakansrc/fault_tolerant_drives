...
#define M2_ADCRESULT_VDC_CLA HWREGH(ADCARESULT_BASE+ADC_O_RESULT4)  //AdcaResultRegs.ADCRESULT4
...
#define M2_PPBADCRESULT_IA_CLA ((signed int)HWREGH(ADCCRESULT_BASE+ADC_O_PPB2RESULT))
#define M2_PPBADCRESULT_IB_CLA ((signed int)HWREGH(ADCBRESULT_BASE+ADC_O_PPB2RESULT))
#define M2_PPBADCRESULT_IC_CLA ((signed int)HWREGH(ADCARESULT_BASE+ADC_O_PPB2RESULT))
...
#define M2_VDC_PIN_VOLTAGE_FLOAT_CLA (VREF * ((float)M2_ADCRESULT_VDC) / ((float)ADC_MAX_12BIT))

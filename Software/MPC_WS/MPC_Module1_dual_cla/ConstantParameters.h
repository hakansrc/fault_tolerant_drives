...
#define M1_ADCRESULT_VDC_CLA HWREG(ADCARESULT_BASE+ADC_O_RESULT1) //AdcaResultRegs.ADCRESULT1
...
#define M2_ADCRESULT_VDC_CLA HWREG(ADCARESULT_BASE+ADC_O_RESULT4)  //AdcaResultRegs.ADCRESULT4

...
;;---------------------------------------------------------------------------- 
    ...
    .align  2
	.def    __cla_CLAexp2_sp
__cla_CLAexp2_sp    .usect ".scratchpad:Cla1Prog:_CLAexp2",6,0,1

_CLAexp2:
    .asmfunc
    .asg    __cla_CLAexp2_sp + 4, _exp2_tmp2
    .asg    __cla_CLAexp2_sp + 2, _exp2_tmp1
    .asg    __cla_CLAexp2_sp + 0, _save_MR3 
; Context Save

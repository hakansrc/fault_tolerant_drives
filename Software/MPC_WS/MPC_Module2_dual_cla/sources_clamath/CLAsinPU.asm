...
;;----------------------------------------------------------------------------
    ...
    .def    _CLAsinPU
    .sect   "Cla1Prog:_CLAsinPU"
    .align  2
    .def    __cla_CLAsinPU_sp
__cla_CLAsinPU_sp   .usect ".scratchpad:Cla1Prog:_CLAsinPU",2,0,1

_CLAsinPU:
    .asmfunc
    .asg    __cla_CLAsinPU_sp + 0, _save_MR3
; Context Save
...
; Context Restore and Final Operations
    MRCNDD   UNC
    MADDF32  MR3,MR2,MR3                       
    MMOV32   MR0,MR3            ; Store Y = SinPU(radPU)

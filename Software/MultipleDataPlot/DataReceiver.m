...
NumberOfFloatsPerPacket = 12;                    %number of floats to be sent at one sending
...
ProcessRawDataThresholdInBytes = 2048*50*10/5/5;    %the received data will be saved and/or converted and plotted when ProcessRawDataThresholdInBytes bytes of data is received

...
ProcessRawDataThresholdInBytes = 2048*50*2;       %the received data will be saved and/or converted and plotted when ProcessRawDataThresholdInBytes bytes of data is received
...
TheSerialChannelDevice = 'COM6';                %set the serial channel device, (this value can be found the device manager)

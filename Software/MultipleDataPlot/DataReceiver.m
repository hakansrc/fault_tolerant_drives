...
ProcessRawDataThresholdInBytes = 2048*50*10/10;    %the received data will be saved and/or converted and plotted when ProcessRawDataThresholdInBytes bytes of data is received
...
%                         ylim([40 120]);
        ...
        if(EnableSaving==1)
            FileName = sprintf("TestData/TestData_TwoModule_fsw1_fsw2_M1id_M1iq_M2id_M2iq_%s", datestr(now, 'ddmmyyHHMMSS'));

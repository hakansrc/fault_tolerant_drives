clc
clear
load('TestData/TestData300120200523.mat');
TheSaveArrayRaw = TheSaveArrayRaw;
MainSignalOffset = 0;
% if the resulting signal is not making any sense make the
% MainSignalOffset 0, 1, 2 or 3 and restart the code for each value
